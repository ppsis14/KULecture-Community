...
Route::get('/admin/posts/category/delete/{id}', 'PostsManagementController@destroyCategory');
Route::get('/admin/posts/category/edit', 'PostsManagementController@updateCategory');
Route::post('/admin/posts/category/add', 'PostsManagementController@addCategory');
