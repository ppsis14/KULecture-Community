                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        @foreach($categories_name as $category)
                            <li><a href="/admin/explorer/category/{{ $category}}">{{ $category}}</a></li>
                        @endforeach
                        <li class="divider"></li>
                        <li><a href="{{ action('AdminExplorePostsController@index')}}">All</a></li>
                    </ul>
                </li>
            </ul>
            <form action="{{ action('AdminExplorePostsController@search', ['dropdown' => $dropdown]) }}" role="search" method="get">
                <div class="col-md-8">
            ...
            <div class="col-sm-6">
              <div class="card" style="padding: 20px;">
                @if($post->post_cover == null)
                    <img src="http://lorempixel.com/400/200" class="card-img-top" alt="Card image cap" style="width: 100%; height: 25em; object-fit: cover"/>
                @endif
                @if($post->post_cover != null)
                    <img src="{{ URL::to('/') }}/images/{{ $post->post_cover }}" class="card-img-top" alt="Card image cap" style="width: 100%; height: 25em; object-fit: cover"/>
                @endif
                <div class="card-body">
